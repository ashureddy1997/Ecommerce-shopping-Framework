...
public class AccountCreationPageTest extends BaseClass {
	...
	@Test(groups="Sanity", alwaysRun=true,dataProvider = "email", dataProviderClass = DataProviders.class)
	 ...
	 * "newAcountDetailsData",dataProviderClass = DataProviders.class) public void
	 * createAccountTest(HashMap<String,String> hashMapValue) throws Throwable {
	 * Log.startTestCase("createAccountTest"); indexPage= new IndexPage();
	 * loginPage=indexPage.clickOnSignIn();
	 ...
	 * homePage.getCurrURL()); Log.endTestCase("createAccountTest"); }
	 */
}
